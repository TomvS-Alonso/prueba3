...
urlpatterns = [
    ...
    path('editar-categoria/<int:idCategoria>',
         editarCategoria, name='modificarCategoria'),
    path('eliminar-categoria/<int:idCategoria>',
         eliminarCategoria, name='eliminarCategoria')
]
